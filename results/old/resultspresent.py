...
def storage():
    ...
    line16 = ax1.plot(x, data.store['mtlsn'], linestyle='-', marker='o', color=data.tlsn_color)
...
def verify():
    ...
    line16 = ax1.plot(x, data.verify['mtlsn'], linestyle='-', marker='h', color=data.tlsn_color)
    ...
    fig.savefig("verify.pdf", bbox_inches='tight', dpi=300)
...
def verify2():
    ...
    plt.figlegend((line11[0], line12[0], line13[0], line14[0]),
                  ('MUSCLE-TP', 'RSA', 'MUSCLE-BP', 'BLS'),
                  loc='lower center', ncol=3, labelspacing=0.)
    plt.show()

    fig.savefig("verify2.pdf", bbox_inches='tight', dpi=300)
...
def total2():
    ...
    fig.savefig("total2.pdf", bbox_inches='tight', dpi=300)
