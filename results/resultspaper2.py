...
def tx():
    ...
    line15 = ax1.plot(x, data.tx['mtlsn'], linestyle=data.mtlsn_ls, color=data.mtlsn_color,
                      marker=data.mtlsn_marker)
    ...
    line21 = ax2.plot(x, data.tx['bgr'], linestyle=data.bgr_ls, color=data.bgr_color)
    line22 = ax2.plot(x, data.tx['rsa'], linestyle=data.rsa_ls, color=data.rsa_color)
    line23 = ax2.plot(x, data.tx['bgls'], linestyle=data.bgls_ls, color=data.bgls_color)
    line24 = ax2.plot(x, data.tx['bls'], linestyle=data.bls_ls, color=data.bls_color)
    line25 = ax2.plot(x, data.tx['ecdsa'], linestyle=data.ecdsa_ls, color=data.ecdsa_color)
...
def storage():
    ...
    line15 = ax1.plot(x, data.store['mtlsn'], linestyle=data.mtlsn_ls, color=data.mtlsn_color,
                      marker=data.mtlsn_marker)
    ...
    line21 = ax2.plot(x, data.store['bgr'], linestyle=data.bgr_ls, color=data.bgr_color)
    line22 = ax2.plot(x, data.store['rsa'], linestyle=data.rsa_ls, color=data.rsa_color)
    line23 = ax2.plot(x, data.store['bgls'], linestyle=data.bgls_ls, color=data.bgls_color)
    line24 = ax2.plot(x, data.store['bls'], linestyle=data.bls_ls, color=data.bls_color)
    line25 = ax2.plot(x, data.store['ecdsa'], linestyle=data.ecdsa_ls, color=data.ecdsa_color)
...
def total():
    ...
    line17 = ax1.plot(x, data.total['ecdsa'], linestyle=data.ecdsa_ls, color=data.ecdsa_color)
    ...
    line25 = ax2.plot(x, data.total['ecdsa'], linestyle=data.ecdsa_ls, color=data.ecdsa_color)
