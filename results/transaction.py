...
def all():
    ...
    tx_bgr = [21000, 73042, 100900, 129143, 157195, 185311]
    tx_rsa = [21000, 67246, 222007, 309047, 396087, 483127]
    tx_tlsn = [21000, 100427, 178667, 256912, 335163, 413553]
    tx_tlsn_single = [21000, 100427, 200854, 301281, 401708, 502135]
